...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        try {
            User loggedInTester = userLoggedInService.getLoggedInUser(); //fetches the details of active tester
            return testRequestQueryService.findByTester(loggedInTester); //fetches all test requests assigned to the tester
